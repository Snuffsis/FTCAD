...
public class ParseException extends Exception
{
	...
	public String toString()
	{
		...
		{
		case 0:
			stringBuffer.append("Unexpected character (").append(this.unexpectedObject).append(") at position ")
					.append(this.position).append(".");
			return stringBuffer.toString();
		case 1:
			stringBuffer.append("Unexpected token ").append(this.unexpectedObject).append(" at position ")
					.append(this.position).append(".");
			return stringBuffer.toString();
		case 2:
			stringBuffer.append("Unexpected exception at position ").append(this.position).append(": ")
